...
//
// DECLARATIONS ONLY - All Definitions in ShapeListingSpecification.cpp
//
...
inline QHash<QString, Qt::PenCapStyle> getPenCapStyleResolver();
inline QHash<QString, Qt::PenJoinStyle> getPenJoinStyleResolver();
inline QHash<QString, Qt::BrushStyle> getBrushStyleResolver();
inline QHash<QString, Qt::Alignment> getAlignmentFlagResolver();
inline QHash<QString, QFont::Style> getFontStyleResolver();
inline QHash<QString, QFont::Weight> getFontWeightResolver();

// Must be created after pPainter is instantiated (in main)
inline QHash<QString, cs1c::Shape*> shapeTypeResolver; // = getShapeTypeResolver(pPainter);
inline QHash<QString, QColor> colorResolver = getColorResolver();
inline QHash<QString, Qt::PenStyle> penStyleResolver = getPenStyleResolver();
inline QHash<QString, Qt::PenCapStyle> penCapStyleResolver = getPenCapStyleResolver();
inline QHash<QString, Qt::PenJoinStyle> penJoinStyleResolver = getPenJoinStyleResolver();
inline QHash<QString, Qt::BrushStyle> brushStyleResolver = getBrushStyleResolver();
inline QHash<QString, Qt::Alignment> alignmentFlagResolver = getAlignmentFlagResolver();
inline QHash<QString, QFont::Style> fontStyleResolver = getFontStyleResolver();
inline QHash<QString, QFont::Weight> fontWeightResolver = getFontWeightResolver();
...
QHash<QString, QFont::Weight> getFontWeightResolver()
{
    ...
    //extern QHash<QString, cs1c::Shape*> getShapeTypeResolver(QPainter* pPainter);
...
//    extern QHash<QString, QColor> colorResolver;
//    extern QHash<QString, Qt::PenStyle> penStyleResolver;
//    extern QHash<QString, Qt::PenCapStyle> penCapStyleResolver;
//    extern QHash<QString, Qt::PenJoinStyle> penJoinStyleResolver;
//    extern QHash<QString, Qt::BrushStyle> brushStyleResolver;
//    extern QHash<QString, Qt::Alignment> alignmentFlagResolver;
//    extern QHash<QString, QFont::Style> fontStyleResolver;
//    extern QHash<QString, QFont::Weight> fontWeightResolver;
